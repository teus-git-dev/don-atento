...
exports.PropertiesModule = PropertiesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [properties_service_1.PropertiesService, bulk_import_service_1.BulkImportService],
        exports: [properties_service_1.PropertiesService, bulk_import_service_1.BulkImportService],
    })
], PropertiesModule);
