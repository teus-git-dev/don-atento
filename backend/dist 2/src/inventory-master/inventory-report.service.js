    ...
    async generateInventoryPDF(propertyId) {
        ...
        return new Promise((resolve, reject) => {
            ...
            for (let i = 0; i < pageCount; i++) {
                doc.switchToPage(i);
                doc.fillColor('#999999').fontSize(8).text('Este documento fue generado automáticamente por el sistema Don Atento IA. La firma digital vinculada a este reporte tiene validez contractual.', 50, 750, { align: 'center', width: 512 });
            }
            doc.end();
        });
    }
