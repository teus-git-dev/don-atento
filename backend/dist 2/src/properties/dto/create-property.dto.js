...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Tenant ID common to the organization', example: 'uuid-tenant-123' }),
    __metadata("design:type", String)
], CreatePropertyDto.prototype, "tenantId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Internal or external property code (ID Inmueble)', example: 'INC-99', required: false }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Property title or name', example: 'Apto 402 Torre B' }),
    __metadata("design:type", String)
