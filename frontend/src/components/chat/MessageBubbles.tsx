...
export const SystemMessage = ({ content }: { content: string }) => (
  <div className="flex justify-center animate-in fade-in duration-500">
    <div className="bg-gray-50 backdrop-blur-sm px-4 py-2 rounded-xl text-xs text-yellow-500/80 border border-yellow-500/20 text-center max-w-[85%] font-mono">
      {content}
    </div>
  </div>
);
...
export const UserBubble = ({ message }: { message: ChatMessage }) => (
  <div className="flex justify-end animate-in fade-in slide-in-from-right-4 duration-300">
    <div className="bg-[#056162] text-[#E9EDEF] p-2.5 rounded-2xl rounded-tr-none max-w-[80%] shadow-md border border-gray-100 relative group">
...
export const AssistantBubble = ({ message }: { message: ChatMessage }) => {
  return (
    <div className="flex justify-start animate-in fade-in slide-in-from-left-4 duration-300">
      <div className="bg-[#202C33] text-[#E9EDEF] p-2.5 rounded-2xl rounded-tl-none max-w-[80%] shadow-md border border-[#10B981]/20 relative group">
        <p className="text-[15px] leading-relaxed whitespace-pre-wrap">{message.content}</p>
        <div className="flex items-center justify-end gap-1 mt-1 opacity-60 group-hover:opacity-100 transition-opacity">
          <div className="p-1 bg-gray-50 rounded-md mr-1 flex items-center gap-1">
...
export const TypingIndicator = () => (
  <div className="flex justify-start animate-in fade-in duration-300">
    <div className="bg-[#202C33] p-3 rounded-2xl rounded-tl-none border border-[#10B981]/30 flex gap-1 items-center">
      <div className="w-2 h-2 rounded-full bg-[#10B981]/60 animate-bounce"></div>
      <div className="w-2 h-2 rounded-full bg-[#10B981]/60 animate-bounce delay-75"></div>
      <div className="w-2 h-2 rounded-full bg-[#10B981]/60 animate-bounce delay-150"></div>
    </div>
  </div>
);
