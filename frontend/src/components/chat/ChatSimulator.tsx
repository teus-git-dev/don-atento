...
export default function ChatSimulator() {
  ...
  return (
    <div className="flex h-full gap-6 select-none">
      ...
      <div className="w-[400px] h-full flex flex-col rounded-[2.5rem] border-[8px] border-black/40 glass shadow-2xl overflow-hidden relative transition-all duration-500 hover:shadow-[0_0_30px_rgba(0,255,255,0.1)]">
        ...
        <div className="bg-[#075E54]/90 backdrop-blur-md pt-10 pb-3 px-4 flex justify-between items-center text-white border-b border-white/10 z-10 shrink-0">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[var(--color-neon-blue)] to-[var(--color-neon-cyan)] flex items-center justify-center border border-white/20 shadow-lg">
            ...
            <div>
              ...
              <p className="text-[10px] text-white/70">entorno de pruebas</p>
            </div>
          </div>
        ...
        {/* Scenario Selector */}
        <div className="bg-[#0b141a] px-4 py-2 flex gap-2 overflow-x-auto border-b border-white/5 no-scrollbar">
            {[
                ...
                <button 
                    ...
                    className="flex-shrink-0 px-3 py-1 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full text-[10px] text-gray-300 transition-colors flex items-center gap-1.5"
                >
        ...
        <div className="bg-black/60 px-4 py-1.5 flex justify-between items-center border-b border-white/5 z-10 shrink-0">
            <div className="flex items-center gap-2">
                <span className="text-[8px] font-mono text-gray-400 uppercase tracking-widest">BPM State:</span>
            ...
            {ticketStatus.id && (
                <div className="flex items-center gap-1.5 text-[9px] font-mono text-[var(--color-neon-cyan)] animate-pulse">
        ...
        {/* Input Area */}
        <div className="bg-[#202C33] p-2 flex items-center gap-2 mb-1 rounded-b-[2rem] shrink-0 border-t border-white/5">
          <div className="bg-[#2A3942] flex-1 rounded-full px-4 py-2 flex items-center border border-white/5 shadow-inner">
            <input 
              type="text" 
              placeholder="Escribe un mensaje aquí..." 
              className="bg-transparent border-none outline-none w-full text-white placeholder:text-gray-400 text-sm py-1" 
              value={inputText}
          ...
          <button 
            className="w-10 h-10 rounded-full bg-[#00A884] flex items-center justify-center hover:bg-[#008f6f] active:scale-95 transition-all shrink-0 shadow-lg text-white disabled:opacity-50"
            onClick={handleSend}
